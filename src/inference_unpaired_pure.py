...
from cyclegan_turbo_bk import CycleGAN_Turbo
from my_utils.training_utils_bk import build_transform
...
if __name__ == "__main__":
    ...
    for input_image_path in  input_images:
            ...
            input_image_label = Image.open(input_image_path.replace('test_A','test_A_seg').replace('_frame_camera.jpg','_gt_labelIds.jpg')).convert("L")
