...
class CycleGAN_Turbo(torch.nn.Module):
    ...
    def load_ckpt_from_state_dict(self, sd):
        ...
        # self.vae_enc.vae.set_adapter(["rainy_vae_skip"])
        # self.vae_enc.vae_b2a.set_adapter(["rainy_vae_skip"])

        # self.vae_dec.vae.set_adapter(["snowy_vae_skip"])
        # self.vae_dec.vae_b2a.set_adapter(["snowy_vae_skip"])
        # self.vae_dec.vae.set_adapter(["rainy_vae_skip"])
        # self.vae_dec.vae_b2a.set_adapter(["rainy_vae_skip"])
    ...
    def get_traininable_params(unet, vae_a2b, vae_b2a):
        ...
        # vae_a2b.lora_params = {
        #     'snowy_vae_skip': [p for n, p in vae_a2b.named_parameters() if "snowy_vae_skip" in n and "lora" in n],
        #     'rainy_vae_skip': [p for n, p in vae_a2b.named_parameters() if "rainy_vae_skip" in n and "lora" in n]}
        # params_gen += vae_a2b.lora_params['snowy_vae_skip'] + vae_a2b.lora_params['rainy_vae_skip']

        vae_a2b.set_adapter(["vae_skip"])
        vae_a2b.lora_params = {
            'vae_skip': [p for n, p in vae_a2b.named_parameters() if "snowy_vae_skip" in n and "lora" in n]}
        params_gen += vae_a2b.lora_params['vae_skip'] 
        ...
        # vae_b2a.lora_params = {
        #     'snowy_vae_skip': [p for n, p in vae_b2a.named_parameters() if "snowy_vae_skip" in n and "lora" in n],
        #     'rainy_vae_skip': [p for n, p in vae_b2a.named_parameters() if "rainy_vae_skip" in n and "lora" in n]}
        # params_gen += vae_b2a.lora_params['snowy_vae_skip'] + vae_b2a.lora_params['rainy_vae_skip']

        vae_b2a.set_adapter(["vae_skip"])
        vae_b2a.lora_params = {
            'vae_skip': [p for n, p in vae_b2a.named_parameters() if "vae_skip" in n and "lora" in n]}
        params_gen += vae_b2a.lora_params['vae_skip'] 
