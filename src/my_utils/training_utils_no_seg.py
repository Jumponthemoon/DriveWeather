...
class UnpairedDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
      ...
      #  img_pil_tgt_label = Image.open(img_path_tgt.replace('train_B','train_B_seg').replace('_rgb_anon_snow.jpg','_gt_labelIds.png').replace('_rgb_anon_rain.jpg','_gt_labelIds.png')).convert("L")
