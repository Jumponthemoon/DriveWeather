...
from cyclegan_turbo_unet_2vae_lora import CycleGAN_Turbo, VAE_encode, VAE_decode, initialize_unet, initialize_vae
...
########################################################################
#                     # 设置 `snowy` LoRA 参数为不可训练
#                     for p in vae_enc.vae.lora_params['vae_skip']:
#                         p.requires_grad = True
#                     # 设置 `snowy` LoRA 参数为不可训练
#                     for p in vae_enc.vae_b2a.lora_params['vae_skip']:
#                         p.requires_grad = True
# #########################################################################
#                     # 设置 `snowy` LoRA 参数为不可训练
#                     for p in vae_dec.vae.lora_params['vae_skip']:
#                         p.requires_grad = True

#                     # 设置 `snowy` LoRA 参数为不可训练
#                     for p in vae_dec.vae_b2a.lora_params['vae_skip']:
#                         p.requires_grad = True
##########################################################################
                else:
                    # print(tgt_weather)
