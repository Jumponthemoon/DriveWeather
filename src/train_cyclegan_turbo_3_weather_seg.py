...
from cyclegan_turbo_3_weather_bc_processor_bk import CycleGAN_Turbo, VAE_encode, VAE_decode, initialize_unet, initialize_vae
...
def main(args):
  ...
  #  params_disc = list(net_disc_a.parameters()) + list(net_disc_b.parameters())
    ...
    fixed_caption_tgt_snow = "Picture of an snowy weather scene"
    fixed_caption_tgt_rain = "Picture of an rainy weather scene"
    fixed_caption_tgt_fog = "Picture of an foggy weather scene"
