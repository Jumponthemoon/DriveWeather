...
def initialize_discriminators():
    discriminators = {
        ...
        "night": vision_aided_loss.Discriminator(cv_type='clip', loss_type=args.gan_loss_type, device="cuda")
...
def main(args):
    ...
    if args.gan_disc_type == "vagan_clip":
        ...
        net_disc_night = vision_aided_loss.Discriminator(cv_type='clip', loss_type=args.gan_loss_type, device="cuda")
        net_disc_night.cv_ensemble.requires_grad_(False)  # Freeze feature extractor
  ...
  #  params_disc = list(net_disc_a.parameters()) + list(net_disc_b.parameters())
    ...
    params_disc_night = list(net_disc_night.parameters()) + list(net_disc_b.parameters())
    ...
    optimizer_disc_fog = torch.optim.AdamW(params_disc_fog, lr=args.learning_rate, betas=(args.adam_beta1, args.adam_beta2),
                                            weight_decay=args.adam_weight_decay, eps=args.adam_epsilon)
    optimizer_disc_night = torch.optim.AdamW(params_disc_night, lr=args.learning_rate, betas=(args.adam_beta1, args.adam_beta2),
                                            weight_decay=args.adam_weight_decay, eps=args.adam_epsilon)
    ...
    lr_scheduler_disc_night = get_scheduler(args.lr_scheduler, optimizer=optimizer_disc_night,
                                        num_warmup_steps=args.lr_warmup_steps * accelerator.num_processes,
                                        num_training_steps=args.max_train_steps * accelerator.num_processes,
                                        num_cycles=args.lr_num_cycles, power=args.lr_power)
    ...
    unet, vae_enc, vae_dec, net_disc_snow, net_disc_rain, net_disc_fog, net_disc_night, net_disc_b = accelerator.prepare(unet, vae_enc, vae_dec, net_disc_snow, net_disc_rain, net_disc_fog, net_disc_night, net_disc_b)




    net_lpips, optimizer_gen, optimizer_disc_snow, optimizer_disc_rain,optimizer_disc_fog, optimizer_disc_night,train_dataloader, lr_scheduler_gen, lr_scheduler_disc_snow, lr_scheduler_disc_rain, lr_scheduler_disc_fog,lr_scheduler_disc_night= accelerator.prepare(
    net_lpips, optimizer_gen, optimizer_disc_snow, optimizer_disc_rain,optimizer_disc_fog,optimizer_disc_night, train_dataloader, lr_scheduler_gen, lr_scheduler_disc_snow, lr_scheduler_disc_rain, lr_scheduler_disc_fog,lr_scheduler_disc_night
)
    ...
    for epoch in range(first_epoch, args.max_train_epochs):
        for step, batch in enumerate(train_dataloader):
           # l_acc = [unet, net_disc_a, net_disc_b, vae_enc, vae_dec]
            l_acc = [unet, net_disc_snow,net_disc_rain,net_disc_fog, net_disc_night,net_disc_b, vae_enc, vae_dec]
            ...
            with accelerator.accumulate(*l_acc):
                ...
                if tgt_weather[0] == 'snow':
                    ...
                    for p in unet.lora_params['night']:
                        p.requires_grad = False
                ...
                if tgt_weather[0] == 'snow':
                    ...
                    loss_gan_a = net_disc_night(fake_b, for_G=True).mean() * args.lambda_gan
                ...
                if tgt_weather[0] == 'snow':
                  ...
                  optimizer_disc_night.zero_grad()
                """
                Identity Objective
                """
                ...
                if tgt_weather[0] =='snow':
                    ...
                    loss_D_A_fake = net_disc_night(fake_b.detach(), for_real=False).mean() * args.lambda_gan
                ...
                if accelerator.sync_gradients:
                    ...
                    if tgt_weather[0] =='snow':
                        ...
                        params_to_clip = list(net_disc_night.parameters()) + list(net_disc_b.parameters()) 
                ...
                if tgt_weather[0]=='snow':
                    ...
                    optimizer_disc_night.step()
                    lr_scheduler_disc_night.step()
                    optimizer_disc_night.zero_grad()
                """
             ...
             #   loss_D_A_real = net_disc_a(img_b, for_real=True).mean() * args.lambda_gan
                if tgt_weather[0] =='snow':
                    ...
                    loss_D_A_real = net_disc_night(img_b, for_real=True).mean() * args.lambda_gan
            ...
            if accelerator.sync_gradients:
                ...
                if accelerator.is_main_process:
                    ...
                    if global_step % args.checkpointing_steps == 1:
                        ...
                        sd["sd_night_encoder"] = get_peft_model_state_dict(eval_unet, adapter_name="night_encoder")
                        sd["sd_night_decoder"] = get_peft_model_state_dict(eval_unet, adapter_name="night_decoder")
                        sd["sd_night_other"] = get_peft_model_state_dict(eval_unet, adapter_name="night_others")           
