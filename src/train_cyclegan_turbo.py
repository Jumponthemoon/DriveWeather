        ...
        for step, batch in enumerate(train_dataloader):
           # l_acc = [unet, net_disc_a, net_disc_b, vae_enc, vae_dec]
            ...
            with accelerator.accumulate(*l_acc):
                ...
                cyc_fake_b = CycleGAN_Turbo.forward_with_networks(img_a, img_a_label,"a2b", vae_enc, unet, vae_dec, noise_scheduler_1step, timesteps, fixed_a2b_emb,alpha)
                cyc_rec_a = CycleGAN_Turbo.forward_with_networks(cyc_fake_b, img_a_label,"b2a", vae_enc, unet, vae_dec, noise_scheduler_1step, timesteps, fixed_b2a_emb,alpha)
                ...
                # B -> fake A -> rec B
                cyc_fake_a = CycleGAN_Turbo.forward_with_networks(img_b, img_b_label,"b2a", vae_enc, unet, vae_dec, noise_scheduler_1step, timesteps, fixed_b2a_emb,alpha)
                cyc_rec_b = CycleGAN_Turbo.forward_with_networks(cyc_fake_a, img_b_label,"a2b", vae_enc, unet, vae_dec, noise_scheduler_1step, timesteps, fixed_a2b_emb,alpha)
                ...
                """
                fake_a = CycleGAN_Turbo.forward_with_networks(img_b, img_b_label, "b2a", vae_enc, unet, vae_dec, noise_scheduler_1step, timesteps, fixed_b2a_emb,alpha)
                fake_b = CycleGAN_Turbo.forward_with_networks(img_a, img_a_label, "a2b", vae_enc, unet, vae_dec, noise_scheduler_1step, timesteps, fixed_a2b_emb,alpha)
                ...
                Identity Objective
                """
                idt_a = CycleGAN_Turbo.forward_with_networks(img_b, img_b_label,"a2b", vae_enc, unet, vae_dec, noise_scheduler_1step, timesteps, fixed_a2b_emb,alpha)
                loss_idt_a = crit_idt(idt_a, img_b) * args.lambda_idt
                loss_idt_a += net_lpips(idt_a, img_b).mean() * args.lambda_idt_lpips
                idt_b = CycleGAN_Turbo.forward_with_networks(img_a, img_a_label,"b2a", vae_enc, unet, vae_dec, noise_scheduler_1step, timesteps, fixed_b2a_emb,alpha)
